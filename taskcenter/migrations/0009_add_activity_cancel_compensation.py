...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("taskcenter", "0008_alter_scheduledtask_task_type"),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("activity_publish_cancel_compensation", "活动发布取消支付补偿"),
                    ("activity_participation_cancel_compensation", "活动报名取消支付补偿"),
                    ("activity_participation_refund", "活动报名退款"),
                    ("activity_publish_refund", "活动发布退款"),
