...
WECHAT_CUSTOMER_MINI_PROGRAM_APP_SECRET = os.getenv(
    "WECHAT_CUSTOMER_MINI_PROGRAM_APP_SECRET", ""
)
WECHAT_PROVIDER_MINI_PROGRAM_APP_ID = os.getenv(
    "WECHAT_PROVIDER_MINI_PROGRAM_APP_ID", ""
)
WECHAT_PROVIDER_MINI_PROGRAM_APP_SECRET = os.getenv(
    "WECHAT_PROVIDER_MINI_PROGRAM_APP_SECRET", ""
)
WECHAT_MINI_PROGRAM_TIMEOUT_SECONDS = int(
    os.getenv("WECHAT_MINI_PROGRAM_TIMEOUT_SECONDS", "10")
)
...
REST_FRAMEWORK["DEFAULT_THROTTLE_RATES"] = {
    ...
    "auth_wechat_login": os.getenv("AUTH_WECHAT_LOGIN_RATE", "20/min"),
